...
window.title("python gui interface\nAbdul Wali Khan University")
# it is necessary to provide the full path, even if the image file is located in the same directory 
icon = PhotoImage(file=r'C:\Users\Shamir Khan\Python projects Local\phase 2\48 GUI\icon2.png')
...
logo_image = Image.open(r'C:\Users\Shamir Khan\Python projects Local\phase 2\48 GUI\awkum.jpg') #this step is optional
photo_image = ImageTk.PhotoImage(logo_image)

label = Label(window,text="Our first label added\nAbdul Wali Khan University Mardan\nawkum@edu.pk.com",
              font=('Arial',20,'bold'),
              bg='lightblue',
              relief='raised',
              border=10,
